...
for(map in  list(c("Bank","Lening naam"),
                 ...
                 c("Vermogen_Maandelijsk_Sparen","Maandelijks sparen (euro)"),
                 c("Vermogen_Beleggingspercentage","beleggingspercentage (%)"),
                 c("Vermogen_Opbrengst","Beleggingen opbrengst (%)"),
                 c("Totaal_Afbetalingen","Totaal afbetalingen (euro)"),
                 c("Totaal_Interesten","Totaal lening interesten (euro)"),
                 c("Totaal_Extra_Kosten","Totaal extra kosten (euro)"),
